...
class ShadowLinkCustomStartOffsetSelectionTests(ShadowLinkPreAllocTestBase):
    ...
    def test_starting_offset(
        ...
        if (
            ...
            and storage_mode == TopicSpec.STORAGE_MODE_VERSION_TIERED_V2
        ):
...
class ShadowLinkingCloudTopicReplicationTests(ShadowLinkPreAllocTestBase):
    ...
    def test_cloud_topic_replication(self, storage_mode):
        ...
        if storage_mode == TopicSpec.STORAGE_MODE_VERSION_TIERED_V2:
            source_version = source_configs[TopicSpec.PROPERTY_STORAGE_MODE_VERSION][0]
            assert source_version == TopicSpec.STORAGE_MODE_VERSION_TIERED_V2, (
        ...
        if storage_mode == TopicSpec.STORAGE_MODE_VERSION_TIERED_V2:
            target_version = target_configs[TopicSpec.PROPERTY_STORAGE_MODE_VERSION][0]
            assert target_version == TopicSpec.STORAGE_MODE_VERSION_TIERED_V2, (
