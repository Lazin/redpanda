...
/// reports success: pre-v26.2 nodes cannot apply the
/// set_min_allowed_local_threshold stm command, and no tiered_cloud topic
/// (the only reader of local data below the floor) can exist yet, so
/// skipping the floor update is safe.
