...
configuration::configuration()
  ...
  , archival_storage_s3_bucket(
      *this,
      ...
      required::no,
      std::nullopt)
  , archival_storage_upload_interval(
      *this,
      "archival_storage_upload_interval",
      "Interval at which the archiving should be performed",
      required::no,
      10s)
  , archival_storage_gc_interval(
      *this,
      "archival_storage_gc_interval",
      "Interval at which the GC job should be started",
      required::no,
      3600s)
