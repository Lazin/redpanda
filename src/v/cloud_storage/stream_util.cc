...
ss::future<stream_util::stream_stats> stream_util::copy_stream(
  ...
  retry_chain_node& fib) {
    ...
    auto pred = [&min_offset, &max_offset](model::record_batch_header& hdr) {
        // NOTE: offset filtering is disabled and the method is used
        // to copy data and collect real segment stats.
