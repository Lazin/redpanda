...
void offset_index::add(
  model::offset rp_offset, model::offset kaf_offset, int64_t file_offset) {
    ...
    try {
        ...
        _kaf_offsets = {};
        _file_offsets = {};
        _rp_index = details::deltafor_encoder<int64_t>(_initial_rp);
        _kaf_index = details::deltafor_encoder<int64_t>(_initial_kaf);
        _file_index = details::deltafor_encoder<int64_t>(_initial_file_pos);
        throw;
    }
}
