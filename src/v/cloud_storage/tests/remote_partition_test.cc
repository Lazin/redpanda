...
static std::vector<s3_imposter_fixture::expectation> make_imposter_expectations(
  cloud_storage::manifest& m, const std::vector<in_memory_segment>& segments) {
    std::vector<s3_imposter_fixture::expectation> results;
    for (const auto& s : segments) {
        // assume all segments has term=1
        auto url = m.get_remote_segment_path(s.sname);
        results.push_back(s3_imposter_fixture::expectation{
...
static auto setup_s3_imposter(
  s3_imposter_fixture& fixture, int num_segments, int num_batches_per_segment) {
    // Create test data
...
static model::record_batch_header read_single_batch_from_remote_partition(
  s3_imposter_fixture& fixture, model::offset target) {
    ...
    remote_partition partition(manifest, api, bucket);
...
static std::vector<model::record_batch_header> scan_remote_partition(
  s3_imposter_fixture& imposter, model::offset base, model::offset max) {
...
FIXTURE_TEST(
  test_remote_partition_single_batch_0, s3_imposter_fixture) { // NOLINT
...
FIXTURE_TEST(
  test_remote_partition_single_batch_1, s3_imposter_fixture) { // NOLINT
    auto segments = setup_s3_imposter(*this, 3, 10);
...
FIXTURE_TEST(
  test_remote_partition_single_batch_2, s3_imposter_fixture) { // NOLINT
    auto segments = setup_s3_imposter(*this, 3, 10);
...
FIXTURE_TEST(
  test_remote_partition_single_batch_3, s3_imposter_fixture) { // NOLINT
    auto segments = setup_s3_imposter(*this, 3, 10);
...
FIXTURE_TEST(
  test_remote_partition_single_batch_4, s3_imposter_fixture) { // NOLINT
    auto segments = setup_s3_imposter(*this, 3, 10);
...
FIXTURE_TEST(test_remote_partition_single_batch_5, s3_imposter_fixture) {
    auto segments = setup_s3_imposter(*this, 3, 10);
...
FIXTURE_TEST(test_remote_partition_scan_full, s3_imposter_fixture) {
...
FIXTURE_TEST(test_remote_partition_scan_first_half, s3_imposter_fixture) {
    constexpr int batches_per_segment = 10;
    constexpr int num_segments = 3;
    constexpr int total_batches = batches_per_segment * num_segments;
...
FIXTURE_TEST(test_remote_partition_scan_second_half, s3_imposter_fixture) {
    constexpr int batches_per_segment = 10;
    constexpr int num_segments = 3;
    constexpr int total_batches = batches_per_segment * num_segments;
...
FIXTURE_TEST(test_remote_partition_scan_middle, s3_imposter_fixture) {
    constexpr int batches_per_segment = 10;
    constexpr int num_segments = 3;
    constexpr int total_batches = batches_per_segment * num_segments;
...
/// This test scans batches in the middle
FIXTURE_TEST(test_remote_partition_scan_off, s3_imposter_fixture) {
    constexpr int batches_per_segment = 10;
    constexpr int num_segments = 3;
    constexpr int total_batches = batches_per_segment * num_segments;
