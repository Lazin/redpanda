...
public:
    ...
    uint64_t get_manifest_upload_backoffs() const { return _cnt_manifest_upload_backoff; }

    /// Register backof invocation during manifest upload
    void manifest_download_backoff() { _cnt_manifest_download_backoff++; }

    /// Get backof invocation during manifest upload or download
    uint64_t get_manifest_download_backoffs() const { return _cnt_manifest_download_backoff; }

    /// Register failed manifest upload
    void failed_manifest_upload() { _cnt_failed_manifest_uploads++; }

    /// Get failed manifest uploads
    uint64_t get_failed_manifest_uploads() const { return _cnt_failed_manifest_uploads; }
    ...
    uint64_t get_failed_manifest_downloads() const { return _cnt_failed_manifest_downloads; }
    ...
    uint64_t get_successful_downloads() const { return _cnt_successful_downloads; }
