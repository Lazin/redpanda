...
/// Wrapper for the cloud_storage::cache
struct cloud_storage_cache_put_api {
    // TODO: add cache put method
};
...
inline std::ostream&
operator<<(std::ostream& o, const cloud_storage_cache_put_api&) {
    return o << "cloud_storage_cache_put_api";
}
inline std::ostream&
...
ss::shared_ptr<archiver_operations_api> make_archiver_operations_api(
  ...
  ss::shared_ptr<cloud_storage_cache_put_api>,
