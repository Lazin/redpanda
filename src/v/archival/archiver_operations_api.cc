...
std::ostream& operator<<(
  ...
  const archiver_operations_api::find_upload_candidates_arg& s) {
    fmt::print(
      o,
      "find_upload_candidates_arg({}, {}, {}, {}, {}, {})",
      s.ntp,
      s.target_size,
      s.min_size,
      s.upload_interval.has_value(),
...
std::ostream& operator<<(
  std::ostream& o,
  const archiver_operations_api::apply_archive_retention_arg& a) {
    fmt::print(
      o, "apply_archive_retention_arg({}, {})", a.ntp, a.delete_op_quota);
    return o;
}

std::ostream& operator<<(
  std::ostream& o,
  const archiver_operations_api::apply_archive_retention_result& a) {
    fmt::print(
      o,
      "apply_archive_retention_result({}, {}, {})",
      a.ntp,
      a.archive_segments_removed,
      a.spillover_manifests_removed);
    return o;
}

std::ostream& operator<<(
  std::ostream& o, const archiver_operations_api::garbage_collect_result& a) {
    fmt::print(
      o,
...
std::ostream& operator<<(
  std::ostream& o, const archiver_operations_api::apply_stm_retention_arg& a) {
    fmt::print(o, "apply_stm_retention_arg({}, {})", a.ntp, a.delete_op_quota);
    return o;
}

std::ostream& operator<<(
  std::ostream& o,
  const archiver_operations_api::apply_stm_retention_result& a) {
    fmt::print(
      o, "apply_archive_retention_result({}, {})", a.ntp, a.segments_removed);
    return o;
}
